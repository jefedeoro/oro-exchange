...
contract('Token', ([deployer, receiver, exchange]) => {
  const name = 'Token de Oro'
  const symbol = 'ORO'
  const decimals = '18'
  const totalSupply = tokens(100000000000).toString()
  let token
  ...
  describe('sending tokens', () => {
    ...
    describe('success', () => {
      ...
      it('transfers token balances', async () => {
        ...
        balanceOf.toString().should.equal(tokens(99999999900).toString())
    ...
    describe('failure', () => {
      it('rejects insufficient balances', async () => {
        let invalidAmount
        invalidAmount = tokens(10000000000000) // 100 million - greater than total supply
  ...
  describe('delegated token transfers', () => {
    ...
    describe('failure', () => {
      it('rejects insufficient amounts', () => {
        ...
        const invalidAmount = tokens(10000000000000)
